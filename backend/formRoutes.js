        ...
        try {
            ...
            const result = await pool.request()
                ...
                .query(`
                    ...
                    FROM BD_PTS.dbo.custom_forms f
                    LEFT JOIN BD_PTS.dbo.courses_main c ON c.course_id = f.course_id
    ...
    router.post('/forms/:formId/submit', async (req, res) => {
        ...
        try {
            ...
            const inserted = await pool.request()
                ...
                .query(`
                    INSERT INTO BD_PTS.dbo.custom_form_responses
        ...
        try {
            ...
            if (courseId) {
                const c = await pool.request()
                    .input('courseId', sql.Int, courseId)
                    .query(`SELECT course_id FROM BD_PTS.dbo.courses_main WHERE course_id=@courseId`);
                if (!c.recordset[0]) {
    ...
    router.put('/forms/:formId', async (req, res) => {
        ...
        try {
            ...
            const cur = await pool.request()
                .input('formId', sql.Int, formId)
                .query(`SELECT * FROM BD_PTS.dbo.custom_forms WHERE form_id=@formId AND ISNULL(flag_use,1)=1`);
        ...
        try {
            ...
            const cur = await pool.request()
                ...
                .query(`
                    ...
                    FROM BD_PTS.dbo.custom_form_questions q
                    INNER JOIN BD_PTS.dbo.custom_forms f ON f.form_id = q.form_id
