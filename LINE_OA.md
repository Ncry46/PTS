...
ให้ใช้งานใน LINE ได้ง่าย และยังคุมธีม PTS (`#ca1156`)
...
## แต่งหน้าให้เหมือน mock (สำคัญ)

โค้ดหน้าแอป + การ์ดในแชทอัปเดตแล้วบน `main`

### A) หน้าใน LINE (LIFF) ให้สวย
1. ใน LINE Developers → LIFF → Endpoint URL ต้องเป็น  
   `https://โดเมนของคุณ/LineApp.html`
2. เปิดจาก Rich Menu / ลิงก์ `https://liff.line.me/YOUR_LIFF_ID`
3. จะเห็นพื้นม่วงอ่อน + การ์ดคอร์สแนวตั้ง + ปุ่ม **รายละเอียด** + แถบนำทางล่าง

### B) เมนูล่างในแชท (Rich Menu 2×2)
บนเซิร์ฟเวอร์ที่มี `.env` ครบ รัน:

```bash
node backend/setup-line-rich-menu.js
```

จะสร้างเมนู: คอร์สเรียน / สมัครเรียน / โปรไฟล์ / ช่วยเหลือ  
แล้วตั้งเป็นค่าเริ่มต้นให้ทุกคน

### C) การ์ดในแชท
- เพิ่มเพื่อน / พิมพ์ข้อความ → การ์ดต้อนรับ + เมนูปัดได้
- ลงทะเบียนสำเร็จ → การ์ดเขียว “ลงทะเบียนสำเร็จแล้ว”
- รอชำระเงิน → การ์ดพร้อมปุ่ม **ชำระเงินตอนนี้**

ต้องเชื่อมบัญชี LINE ในแอปก่อน ระบบถึงจะส่งการ์ดหาคนนั้นได้
